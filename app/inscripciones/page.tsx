                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            className={`w-5 h-5 rounded-full ${getCaritaColor(estado as 'PAGADA' | 'PENDIENTE', estaRetirado)} text-white flex items-center justify-center transition-colors flex-shrink-0 ${
                          ...
                          >
                            <span className="text-[9px]">{getCaritaEmoji(estado as 'PAGADA' | 'PENDIENTE', estaRetirado)}</span>
                          </button>
                        </div>
                      )
                    })}
